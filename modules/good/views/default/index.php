...
<main>
    ...
    <div id="main-info">
        ...
        <p id="good-description">Юбка-солнце. Посадка на талии. Длина ок. 65 см. Юбка выкроена без шва, на всю ширину ткани. Пояс шириной ок. 6 см, из плотного трикотажного полотна вязанного резинкой (рибаны), продублирован резинкой эластичной. Легко одевается без всяких молний))
            ...
            Стоимость указана вместе с данным на фото используемым материалом для данного размера. Окончательная стоимость зависит от расхода выбранного материала и его стоимости.</p>
